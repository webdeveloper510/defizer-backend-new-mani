...
function _getIdentifiers(x) {
  ...
  if (x.body) {
    var result = [];
    for (var _i8 = 0, _x$body4 = x.body; _i8 < _x$body4.length; _i8++) {
      var arg = _x$body4[_i8];
      pushArray(result, _getIdentifiers(arg));
    }
    return result;
  }
  if (x.type === "CallExpression") {
    if (x.arguments) {
      var _result = [];
      for (var _i0 = 0, _x$arguments4 = x.arguments; _i0 < _x$arguments4.length; _i0++) {
        var _arg = _x$arguments4[_i0];
        pushArray(_result, _getIdentifiers(_arg));
      }
      return _result;
    }
  }
        ...
        var px = new Proxy({}, {
          ...
          get: function get(target, name) {
            ...
            if (config.evaluateIdentifier) {
              var fnResult;
              if (lastResult != null && lastResult[0] === name && lastResult[1] === target) {
                fnResult = lastResult[2];
              } else {
                fnResult = config.evaluateIdentifier(name, scope, scopeList, context);
              }
            ...
            if (name === "$index") {
              var res = getIndex(scope, context);
              if (res != null) {
                return res;
              }
            }
