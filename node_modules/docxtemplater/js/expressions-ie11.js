...
function _getIdentifiers(x) {
  ...
  if (x.body) {
    var result = [];
    for (var _i6 = 0, _x$body4 = x.body; _i6 < _x$body4.length; _i6++) {
      var y = _x$body4[_i6];
      pushArray(result, _getIdentifiers(y));
    }
    return result;
  }
  if (x.type === "CallExpression") {
    if (x.arguments) {
      var _result = [];
      for (var _i8 = 0, _x$arguments4 = x.arguments; _i8 < _x$arguments4.length; _i8++) {
        var arg = _x$arguments4[_i8];
        pushArray(_result, _getIdentifiers(arg));
      }
      return _result;
    }
  }
